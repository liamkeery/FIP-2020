...
<section id="aboutUs">
  <div class="row mx-auto text-center">
      <div class="col-lg-6 col-sm-12 mt-0">
        <img src="./images/eggp.svg" alt="Eggplant" class="eggp">
      </div>
...
<div class="row mx-auto text-center">
    <div class="col-lg-6 col-sm-12 mr-0">
      <p class="text-left">
      ...
      <h1 class="text-center mx-auto openup-h1">#OPENUP</h1>
    </div>
    <div class="col-lg-6 col-sm-12 mr-0">
      <img src="./images/citrus-girl.png" alt="Eggplant" class="citrusg">
    </div>
</div>
</section>
    `,
